...
void RandomMersenneTwister::GetLogNormals(double m, double s, MJArray& variates)
{
	for (unsigned long j = 0; j < GetDimensionality(); j++){
...
void RandomMersenneTwister::GetExponentials(double lambda, MJArray& variates)
{
	for (unsigned long j = 0; j < GetDimensionality(); j++){
...
void RandomMersenneTwister::GetPoissons(double lambda, MJArray& variates)
{
	for (unsigned long j = 0; j < GetDimensionality(); j++){
...
void RandomMersenneTwister::GetGammas(double alpha, double beta, MJArray& variates)
{
	for (unsigned long j = 0; j < GetDimensionality(); j++){
...
void RandomMersenneTwister::GetBetas(double alpha, double beta, MJArray& variates)
{
	for (unsigned long j = 0; j < GetDimensionality(); j++){

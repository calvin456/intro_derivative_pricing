...
void AntiThetic::GetLogNormals(double m, double s, MJArray& variates){ InnerGenerator->GetLogNormals(m, s, variates); }
void AntiThetic::GetExponentials(double lambda, MJArray& variates){ InnerGenerator->GetExponentials(lambda, variates); }
void AntiThetic::GetPoissons(double lambda, MJArray& variates){ InnerGenerator->GetPoissons(lambda, variates); }
void AntiThetic::GetGammas(double alpha, double beta, MJArray& variates){ InnerGenerator->GetGammas(alpha, beta, variates); }
void AntiThetic::GetBetas(double alpha, double beta, MJArray& variates){ InnerGenerator->GetBetas(alpha, beta, variates); }

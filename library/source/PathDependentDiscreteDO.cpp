//PathDependentDiscreteDO.cpp


#include <cmath>
#include <PathDependentDiscreteDO.h>

PathDependentDiscreteDO::PathDependentDiscreteDO(const MJArray& LookAtTimes_,
...
unsigned long PathDependentDiscreteDO::CashFlows(const MJArray& SpotValues,
...
PathDependent* PathDependentDiscreteDO::clone() const
{
	return new PathDependentDiscreteDO(*this);
}

...
//VanillaOption1::VanillaOption1(const unique_ptr<PayOff>& ThePayOffPtr_, double Expiry_)
//	: _ThePayOffPtr(ThePayOffPtr_),Expiry(Expiry_)
//{}
...
double VanillaOption1::OptionPayOff(double Spot) const
{
	...
	//return _ThePayOffPtr->operator ()(Spot);
}

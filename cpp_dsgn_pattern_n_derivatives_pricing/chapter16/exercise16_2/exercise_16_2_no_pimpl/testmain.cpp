...
//benchmark compiling time of pimpl version against book solution
// 2158/674 = 3.20
// On this particular built pimpl version appears to compile 3 times faster than original book version

/*

1>               3426 ms  Build                                      1 calls
1>
...
1>     1227 ms  Link                                       1 calls
1>     2158 ms  ClCompile                                  1 calls
1>
1>Build succeeded.
1>
1>Time Elapsed 00:00:03.43
...
int main(){
	...
	cout << "option 1 call ";
	unique_ptr<VanillaOption1> myOption(new VanillaOption1(new PayOffCall(Strike), Expiry));

	cout << "payoff with spot 110 : ";
	cout << myOption->OptionPayOff(110.0) << endl;

	cout << "option 2 call ";
	unique_ptr<VanillaOption1>myOption1(new VanillaOption1(new PayOffCall(Strike), Expiry));

...
//test Asian and discrete barrier option w/ speed-up version
...
int main(){
	...
	try{
		...
		std::shared_ptr<Option> call(new CallOption(Spot, Strike, _r[_r.size() - 2], _d[_d.size() - 2], _Vol[_Vol.size() - 2], _time));
		...
		ExoticBSEngine theEngine(theOption, rParam, dParam, VolParam, GenTwo, Spot, true);

		//ExoticBSEngine theEngine(theOption, _rParam, _dParam, _VolParam, GenTwo, Spot, true);
		...
		std::shared_ptr<Option> call1(new CallOption(Spot, Strike, _r1[_r1.size() - 2], _d1[_d1.size() - 2], _Vol1[_Vol1.size() - 2], _time1));

		PathDependentAsianSU theOption1(times1, Expiry, call1);

		GenTwo.Reset();

		ExoticBSEngine theEngine1(theOption1, rParam, dParam, VolParam, GenTwo, Spot, true);

		//ExoticBSEngine theEngine1(theOption1, _rParam1, _dParam1, _VolParam1, GenTwo, Spot, true);
		...
		std::shared_ptr<Option> call2(new CallOption(Spot, Strike, _r2[_r2.size() - 1], _d2[_d2.size() - 1], _Vol2[_Vol2.size() - 1], _time2));

		PathDependentAsianSU theOption2(times2, Expiry, call2);

		GenTwo.Reset();

		ExoticBSEngine theEngine2(theOption2, rParam, dParam, VolParam, GenTwo, Spot, true);

		//ExoticBSEngine theEngine2(theOption2, _rParam2, _dParam2, _VolParam2, GenTwo, Spot, true);
		...
		std::shared_ptr<Option> _call(new CallOption(Spot, Strike, _r[_r.size() - 1], _d[_d.size() - 1], _Vol[_Vol.size() - 1], _time));
		...
		ExoticBSEngine theEngine3(theOption3, rParam, dParam, VolParam, GenTwo, Spot, true);

		//ExoticBSEngine theEngine3(theOption3, _rParam, _dParam, _VolParam, GenTwo, Spot, true);
		...
		ExoticBSEngine theEngine4(theOption4, rParam, dParam, VolParam, GenTwo, Spot, true);

		//ExoticBSEngine theEngine4(theOption4, _rParam, _dParam, _VolParam, GenTwo, Spot, true);
		...
		std::shared_ptr<Option> put(new PutOption(Spot, Strike, _r[_r.size() - 1], _d[_d.size() - 1], _Vol[_Vol.size() - 1], _time));

		PathDependentDiscreteDOSU theOption5(times, Expiry, BarrierDown, put);

		GenTwo.Reset();

		ExoticBSEngine theEngine5(theOption5, rParam, dParam, VolParam, GenTwo, Spot, true);

		//ExoticBSEngine theEngine5(theOption5, _rParam, _dParam, _VolParam, GenTwo, Spot, true);
		...
		std::shared_ptr<Option> put1(new PutOption(Spot, Strike, _r3[_r3.size() - 1], _d3[_d3.size() - 1], _Vol3[_Vol3.size() - 1], _time3));
		...
		ExoticBSEngine theEngine6(theOption6, rParam, dParam, VolParam, GenTwo, Spot, true);

		//ExoticBSEngine theEngine6(theOption6, _rParam3, _dParam3, _VolParam3, GenTwo, Spot, true);

...
//test Asian and discrete barrier option n + QMC (Sobol sequence) + Brownian bridge
...
int main(){
	...
	try{
		...
		ExoticBSEngineBB theEngine(theOption, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEngineBB theEngine(theOption, _rParam, _dParam, _VolParam, GenTwo, Spot);
		...
		ExoticBSEngineBB theEngine1(theOption1, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEngineBB theEngine1(theOption1, _rParam1, _dParam1, _VolParam1, GenTwo, Spot);
		...
		ExoticBSEngineBB theEngine2(theOption2, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEngineBB theEngine2(theOption2, _rParam2, _dParam2, _VolParam2, GenTwo, Spot);
		...
		ExoticBSEngineBB theEngine3(theOption3, rParam, dParam, VolParam, GenTwo, Spot,true);
		...
		ExoticBSEngineBB theEngine4(theOption4, rParam, dParam, VolParam, GenTwo, Spot,true);
		...
		ExoticBSEngineBB theEngine5(theOption5, rParam, dParam, VolParam, GenTwo, Spot,true);
		...
		ExoticBSEngineBB theEngine6(theOption6, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEngineBB theEngine6(theOption6, _rParam3, _dParam3, _VolParam3, GenTwo, Spot);

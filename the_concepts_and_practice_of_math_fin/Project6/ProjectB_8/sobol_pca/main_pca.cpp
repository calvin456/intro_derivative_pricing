...
//test Asian and discrete barrier option w/ speed-up version + QMC (Sobol sequence) + PCA 
...
int main(){
	...
	try{
		...
		ExoticBSEnginePCA theEngine(theOption, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEnginePCA theEngine(theOption, _rParam, _dParam, _VolParam, GenTwo, Spot);
		...
		ExoticBSEnginePCA theEngine1(theOption1, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEnginePCA theEngine1(theOption1, _rParam1, _dParam1, _VolParam1, GenTwo, Spot);
		...
		ExoticBSEnginePCA theEngine2(theOption2, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEnginePCA theEngine2(theOption2, _rParam2, _dParam2, _VolParam2, GenTwo, Spot);
		...
		ExoticBSEnginePCA theEngine3(theOption3, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEnginePCA theEngine3(theOption3, _rParam, _dParam, _VolParam, GenTwo, Spot);
		...
		ExoticBSEnginePCA theEngine4(theOption4, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEnginePCA theEngine4(theOption4, _rParam, _dParam, _VolParam, GenTwo, Spot);
		...
		ExoticBSEnginePCA theEngine5(theOption5, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEnginePCA theEngine5(theOption5, _rParam, _dParam, _VolParam, GenTwo, Spot);
		...
		ExoticBSEnginePCA theEngine6(theOption6, rParam, dParam, VolParam, GenTwo, Spot,true);

		//ExoticBSEnginePCA theEngine6(theOption6, _rParam3, _dParam3, _VolParam3, GenTwo, Spot);
